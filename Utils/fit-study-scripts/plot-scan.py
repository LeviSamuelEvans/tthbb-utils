...
def plot_likelihood_scan(data, systematic, savepath)-> None:
    ...
    plt.close()
    print(f"INFO: Plots saved to {savepath} as LHscan_{systematic}.png and LHscan_{systematic}.pdf")
...
if __name__ == '__main__':
    ...
    parser.add_argument('-f', '--folder-path', type=str, help="Path to the folder containing scan YAML files.")
    parser.add_argument('-p', '--save-path', type=str, help="path of the folder to save the plots.")
