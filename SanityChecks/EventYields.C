/*
===================================================================================
==============   Script to check event yields in L2 samples   =====================
===================================================================================

Description:
    - This script will calculate the weighted event yields for each sample in a given
      directory and subdirectories.

Usage:
    - compile using g++ -o EventYields EventYields.C `root-config --cflags --libs`
    - This will create an executable that can be run with ./EventYields
    - When running the script you will be promted to enter the top directory where
      all the .root files are found, the script will recursivley find all .root files
      in all directories.
    - a log file will be produced with a table of weighted Event yields for each
      sample

TODO:
    - Less hardcoding of variables
    - compile results into useful table format
...
// Count the number of .root files in a directory
...
// Recursively process all .root files in a directory
